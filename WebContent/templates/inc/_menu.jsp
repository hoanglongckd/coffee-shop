	...
	<div class="navbar-default sidebar" role="navigation">
		<div class="sidebar-nav navbar-collapse">
			<ul class="nav" id="side-menu">
                ...
                <li>
                    <a  href="#"><i class="fa fa-bars"></i> Thực đơn<span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                    	<li><a href="<%=request.getContextPath()%>/admin/addMenu">Thêm thực đơn</a></li>
                        <li><a href="<%=request.getContextPath()%>/admin/indexMenu">Danh sách thực đơn</a></li>
                    </ul>
                    <!-- /.nav-second-level -->
                </li>
                ...
                <li>
                    <a href="<%=request.getContextPath()%>/admin/indexStock"><i class="glyphicon glyphicon-inbox"></i> Quản Lý Kho <span class="fa arrow"></span></a>
                    <!-- /.nav-second-level -->
                </li>
                ...
                <li>
					<a href="#"><i class="fa fa-usd"></i> Thống kê lợi nhuận<span class="fa arrow"></span></a>
						<ul class="nav nav-second-level">
							<li><a href="<%=request.getContextPath()%>/admin/thong-ke-theo-thang">Theo tháng</a></li>
							<li><a href="<%=request.getContextPath()%>/admin/thong-ke-theo-nam">Theo năm</a></li>
						</ul>
					<!-- /.nav-second-level -->
				</li>
